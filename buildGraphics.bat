...
cl %CFLAGS% %ADDITIONAL% ..\src\graphics\graphics.cpp /MD -LD %LIBS% /link game_common.lib -LIBPATH:"../deps/lib" -incremental:no -opt:ref -PDB:graphics_%random%.pdb /LIBPATH:"../deps/lib" 
del lock.tmp
